...
class CrearItem(TemplateView):
    # Default template file
    # Refer to dashboards/urls.py file for more pages and template files
    template_name = 'pages/CRUD/template-crear.html'
...
class EditarItem(TemplateView):
    # Default template file
    # Refer to dashboards/urls.py file for more pages and template files
    template_name = 'pages/CRUD/template-editar.html'
...
class IndexItem(TemplateView):
    # Default template file
    # Refer to dashboards/urls.py file for more pages and template files
    template_name = 'pages/CRUD/template-index.html'
